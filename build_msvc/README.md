Building Elecric Cash Core with Visual Studio
========================================
...
To build Elecric Cash Core without Qt unload or disable the `elcash-qt`, `libelcash_qt` and `test_elcash-qt` projects.
