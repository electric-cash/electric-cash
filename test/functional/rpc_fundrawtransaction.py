...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def test_change_position(self):
        ...
        rawmatch = self.nodes[2].createrawtransaction([], {self.nodes[2].getnewaddress(): 450})
    ...
    def test_locked_wallet(self):
        ...
        # Make sure funds are received at node1.
        assert_equal(oldBalance+Decimal('451.10000000'), self.nodes[0].getbalance())
    ...
    def test_many_inputs_send(self):
        ...
        self.nodes[1].generate(1)
        self.sync_all()
        assert_equal(oldBalance+Decimal('450.19000000'), self.nodes[0].getbalance()) #0.19+block reward
