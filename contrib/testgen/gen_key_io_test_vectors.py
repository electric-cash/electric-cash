...
bech32_templates = [
  ...
  ('elcash',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('elcash',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('elcash',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('telcash',    0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('telcash',    0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('telcash',    2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('relcash',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('relcash',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('relcash', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tb',    0, 20, False, False, False),
  ('telcash',   17, 32, False, False, False),
  ('relcash',  3,  1, False, False, False),
  ('elcash',   15, 41, False, False, False),
  ('telcash',    0, 16, False, False, False),
  ('relcash',  0, 32, True,  False, False),
  ('elcash',    0, 16, True,  False, False),
  ('telcash',    0, 32, False, True,  False),
  ('relcash',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['elcash', 'telcash', 'relcash']:
