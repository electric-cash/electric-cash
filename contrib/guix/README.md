# Bootstrappable Elecric Cash Core Builds
...
- 24GB of free disk space on the partition that the Elecric Cash Core git repository
  resides in
...
For a Elecric Cash Core depends development environment, simply invoke
...
From the top of a clean Elecric Cash Core repository:
...
To use dongcarl's substitute server for Elecric Cash Core builds after having
