...
BOOST_FIXTURE_TEST_CASE(scan_for_wallet_transactions, TestChain100Setup)
{
    ...
    // and new block files.
    {
        ...
        BOOST_CHECK_EQUAL(wallet.GetBalance().m_mine_immature, 900 * COIN); // 90% of 1000
    }
...
BOOST_FIXTURE_TEST_CASE(coin_mark_dirty_immature_credit, TestChain100Setup)
{
    ...
    BOOST_CHECK_EQUAL(wtx.GetImmatureCredit(), 450 * COIN); // 90% of 500
}
...
BOOST_FIXTURE_TEST_CASE(ListCoins, ListCoinsTestingSetup)
{
    ...
    // Only 90% of initial 500 goes to miner
    BOOST_CHECK_EQUAL(450 * COIN, wallet->GetAvailableBalance());
