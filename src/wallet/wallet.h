...
#ifndef ELCASH_WALLET_WALLET_H
#define ELCASH_WALLET_WALLET_H
...
struct CoinSelectionParams
{
    ...
    bool avoid_partial_spends = false;
    ...
    CoinSelectionParams(bool use_bnb, size_t change_output_size, size_t change_spend_size, CFeeRate effective_feerate,
        ...
        discard_feerate(discard_feerate),
        tx_noinputs_size(tx_noinputs_size),
        avoid_partial_spends(avoid_partial)
        {}
    CoinSelectionParams() {}
};
