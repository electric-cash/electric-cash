...
#ifndef ELCASH_SCRIPT_BITCOINCONSENSUS_H
#define ELCASH_SCRIPT_BITCOINCONSENSUS_H

#include <stdint.h>

#if defined(BUILD_ELCASH_INTERNAL) && defined(HAVE_CONFIG_H)
#include <config/elcash-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBELCASHCONSENSUS)
...
#endif // ELCASH_SCRIPT_BITCOINCONSENSUS_H
