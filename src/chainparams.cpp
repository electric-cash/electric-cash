...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    txNew.vin.resize(1);
    txNew.vout.resize(1);
    txNew.vin[0].scriptSig = CScript() << 486604799 << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
...
{
    const char* pszTimestamp = "We'll aim to make crypto transfers so cheap (& fast) that only the rich will use banks.";
    const CScript genesisOutputScript = CScript() << ParseHex("021eeacfd38a03fa3eceea46694a2673f933348fa41a4633b5dffd7799154e26d9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1608451200, 3970812118, 0x1d00ffff, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000a9811adc411f15a9c525d667ca467d83dc5461e2d7fc791d1d3926de"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1600000200, 4101757323, 0x1d00ffff, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000d491a4c437cab521a329bb967c3a2bcb849a83a2c53f7f3c50179ab6"));
        assert(genesis.hashMerkleRoot == uint256S("0xd3133f9c8d4261f44fbd2a8029c56d5d97106adfef11c652d971796cc75dd967"));
