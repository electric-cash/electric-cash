...
// (pre-BIP34) cases.
void AddCoins(CCoinsViewCache& cache, const CTransaction& tx, int nHeight, bool check = false, bool fStakingActive = false, size_t nStakeOutputNumber = 0);
 ...
 * between elcashd, and elcash-qt and non-server tools.
 *
