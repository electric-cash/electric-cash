...
#ifndef ELCASH_VALIDATION_H
#define ELCASH_VALIDATION_H
...
bool TestBlockValidity(BlockValidationState& state, const CChainParams& chainparams, const CBlock& block, CBlockIndex* pindexPrev, bool fCheckPOW = true, bool fCheckMerkleRoot = true, bool fCheckDdms = true) EXCLUSIVE_LOCKS_REQUIRED(cs_main);
...
public:
    ...
    DisconnectResult DisconnectBlock(const CBlock& block, const CBlockIndex* pindex, CCoinsViewCache& view, const CChainParams& chainparams, CStakesDB& stakes);
