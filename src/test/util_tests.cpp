...
BOOST_FIXTURE_TEST_CASE(util_ArgsMerge, ArgsMergeTestingSetup)
{
    ...
    //
    //   ARGS_MERGE_TEST_OUT=results.txt ./test_elcash --run_test=util_tests/util_ArgsMerge
    //
...
BOOST_FIXTURE_TEST_CASE(util_ChainMerge, ChainMergeTestingSetup)
{
    ...
    // If check below fails, should manually dump the results with:
    //
    //   CHAIN_MERGE_TEST_OUT=results.txt ./test_elcash --run_test=util_tests/util_ChainMerge
    //
    // And verify diff against previous results to make sure the changes are expected.
    //
    // Results file is formatted like:
...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("electriccash"), "Electriccash");
...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "cAo89mg9TNUyydu9f8rjtotq8XtKo7we6o",
            "signature should be irrelevant",
            "message too"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "EbzVgQBUWCTLkkz4sLZJDMoWWPz4CTNbkM",
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "EMMLSqUUrmZUKoknw8movdcsVe8TXmDS9e",
            "IPojfrX2dfPnH26UegfbGQQLrdK844DlHq5157/P6h57WyuS/Qsl+h/WSVGDF4MUi4rWSswW38oimDYfNNUBUOk=",
            "I never signed this"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "EHAX5NkDF6owN7Do1g7UNzPWEQyp1JGFNb",
